...
use Modules\Order\Http\Controllers\Api\OrderItemController;
use Modules\Order\Http\Controllers\Api\OrderItemControllerInterface;

use Modules\Order\Services\OrderService;
use Modules\Order\Services\OrderServiceInterface;

use Modules\Order\Services\OrderItemService;
use Modules\Order\Services\OrderItemServiceInterface;
...
class OrderServiceProvider extends ServiceProvider
{
    ...
    public function registerViews(): void
    {
        ...
        $this->loadViewsFrom(
            module_path('Order', 'Resources/views'),
            'order'
        );
    ...
    private function _binds(): void
    {
        $this->app->bind(OrderControllerInterface::class, OrderController::class);
        $this->app->bind(OrderServiceInterface::class, OrderService::class);
        
        $this->app->bind(OrderItemControllerInterface::class, OrderItemController::class);
