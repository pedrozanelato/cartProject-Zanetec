...
use Modules\Cart\Http\Controllers\Api\CartItemController;
...
class CartServiceProvider extends ServiceProvider
{
    ...
    public function registerViews(): void
    {
        ...
        $this->loadViewsFrom(
            module_path('Cart', 'Resources/views'),
            'cart'
        );
    ...
    {
        $this->app->bind(CartControllerInterface::class, CartController::class);
        $this->app->bind(CartServiceInterface::class, CartService::class);
        
        $this->app->bind(CartItemControllerInterface::class, CartItemController::class);
